...
export default function Hero() {
  return (
    <section className="flex flex-col items-center text-center px-6 py-20">
      ...
      <h1 className="text-5xl font-extrabold text-gray-900">Olá, eu sou</h1>
      ...
      <p className="mt-6 max-w-xl text-gray-500">
        Transformo ideias complexas em soluções digitais acessíveis, escaláveis
        e centradas em pessoas.
      </p>
